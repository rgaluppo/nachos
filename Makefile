...
clean:
	$(SH) -c "rm -f */{core,nachos,DISK,*.o,swtch.s} test/*.coff bin/{coff2flat,coff2noff,disassemble,out} vm/swap.* vm/stats.txt informe/*.aux informe/*.bbl  informe/*.blg informe/*.out informe/*.toc informe/*.synctex.gz borrar.txt"
